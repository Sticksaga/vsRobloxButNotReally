...
tnhx = -10
function onCreate()
    makeLuaText("tnh", 'Notes Hit In Song: 0', 250, tnhx, 259);
    setTextColor('tnh', 'FFA200');
    setTextFont('tnh', font)
    makeLuaText("cm", 'Combos Continuation: 0', 200, -getProperty('tnh.x') + cmoffset, getProperty('tnh.y') + cmy);
    setTextColor('cm', '2112FA');
